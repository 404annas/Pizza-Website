...
export default function PopularPizza({ activeCategory }) {
    ...
    return (
        <section className="w-full pt-10 relative overflow-hidden">
            ...
            {/* Explore Menu Button */}
            <div className="absolute left-1/2 bottom-30 -translate-x-1/2 z-10 pointer-events-none">
            ...
            <h1 className="text-center text-[130px] font-black tracking-tighter text-black pointer-events-none uppercase">
                {activeCategory}
            </h1>
        </section>
    );
